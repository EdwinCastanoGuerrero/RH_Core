    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4">
                ...
                <!-- login form -->
                <div class="card p-5" style="backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); background-color: rgba(255, 255, 255, 0.15); border: 1px solid rgba(255, 255, 255, 0.2);">
